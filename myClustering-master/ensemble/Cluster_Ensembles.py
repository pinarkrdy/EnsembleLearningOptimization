...
def HGPA(hdf5_file_name, cluster_runs, verbose=False, N_clusters_max=None,
    ...
    return hmetis(hdf5_file_name, N_clusters_max, weighted=weighted)
...
def MCLA(hdf5_file_name, cluster_runs, verbose=False, N_clusters_max=None):
    ...
    print ('MCLA labels num:'+str(len(np.unique(cluster_labels))))
...
def hmetis(hdf5_file_name, N_clusters_max, w=None, weighted=False):
    ...
    if w is None:
        file_name = wgraph(hdf5_file_name, None, 2, HGPA_weighted=weighted)
    else:
