...
# DCCP is an optimization method which combines the idea of disciplined
# convex programming (DCP) and convex-concave programming (CCP). DCP
# requires a set of conventions to follow when problems are generated whereas
# CCP is an organized heuristic for solving nonconvex problems.A conic solver called Splitting Conic Colver (SCS) in DCCP package
# was used to solve the problem.

# Parameters
#     ----------
#     T : array of shape -  Accuricy diverstiy matrix
#     Rho=array of shape
#
#     Returns
#     solution_list = selected feature id
def dccpFunc(T,Rho):
    eps = 10 ** -2
    # eps = 10
    _teta = 1 / eps
