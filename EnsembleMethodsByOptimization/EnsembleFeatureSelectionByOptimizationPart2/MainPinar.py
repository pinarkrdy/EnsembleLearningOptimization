...
# classifcation accuracy.In this method we applyed svm for testing our result
...
sq =SqlLiteDatabase.SqlLiteDatabase('...\scikit-feature-master\skfeature\FeatureSelectionDB_Madelon.db')
...
#mat = scipy.io.loadmat('..skfeature/data/madelon.mat')
#mat = scipy.io.loadmat('..skfeature/data/warpAR10P.mat')
# mat = scipy.io.loadmat('..skfeature/data/Yale.mat')
...
for s in range(5):
    ...
    for i in range(rowLen):
        for j in range(rowLen):
            ...
            if multiClass == False:
                ...
                clf = svm.SVC(kernel='linear', gamma=0.7, C=1.0, decision_function_shape='ovo').fit(X_train1, y_train1)
    ...
    for train_index, test_index in loo.split(prunedX3):
        ...
        if multiClass == False:
            ...
            clf = svm.SVC(kernel='linear', gamma=0.7, C=1.0,decision_function_shape='ovo').fit(X_train3, y_train3)
